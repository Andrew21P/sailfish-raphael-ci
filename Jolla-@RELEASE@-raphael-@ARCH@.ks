...
### Repositories
repo --name=adaptation0-raphael-@RELEASE@ --baseurl=file://@REPO@
repo --name=adaptation-community-common-raphael-@RELEASE@ --baseurl=https://repo.sailfishos.org/obs/nemo:/testing:/hw:/common/sailfishos_5.0_@ARCH@/
